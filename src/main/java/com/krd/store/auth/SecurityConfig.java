 ...
 * <p>
 * Overrides the default SecurityFilterChain from spring-api-starter to configure:
 * - Public endpoints (auth, user registration, actuator)
 * - CORS settings for React frontend
 * - Security rules from security-rules-starter
 * <p>
 * PasswordEncoder and AuthenticationManager beans are provided by spring-api-starter.
 */
@Configuration
@AllArgsConstructor
